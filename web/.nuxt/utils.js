...
export async function setContext(app, context) {
  ...
  if (!app.context) {
    app.context = {
      ...
      error: context.error,
      base: '/',
      env: {"DEVELOPMENT_URL":"http://120.78.68.106:8090/","PRODUCTION_URL":"http://120.78.68.106/bdd-web/","RESOURCE_URL":"https://bdd-dev.oss-cn-shenzhen.aliyuncs.com/","STATIC_PATH":""}
    }
    // Only set once
    if (context.req) {
