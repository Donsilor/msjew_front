      ...
      <dl>
        ...
        <dd>
          ...
          <div class="country">
            ...
            <ul>
              <li v-for="(item, index) in $t(`${lang}.delivery`)" :key="index">
        ...
        <dd>
          {{ $t(`${lang}.con7`) }}
          <a href="https://www.fedex.com/zh-hk/home.html" target="_blank">
            <span>{{ $t(`${lang}.link4`) }}</span>
          </a>
          <br />
          {{ $t(`${lang}.tip1`) }}
        </dd>
