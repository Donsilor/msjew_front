<template>
  <layout>
    <div class="content page-content">
      ...
      <div class="page-box">
        <el-pagination @current-change="" :current-page="currentPage4" :page-size="page_size" layout="total, prev, pager, next, jumper"
          :total="totalCount">
        </el-pagination>
      </div>
    </div>
...
<script>
  import Layout from '@/pageComponents/news/news-classify.vue'
