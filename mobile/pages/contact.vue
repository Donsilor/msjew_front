  ...
  <div class="page">
    ...
    <section v-show="isSuccessful" class="submit-successful">
      <div class="status-icon">
        <img src="../static/contact-successful.png" />
      </div>
    ...
    <section class="contact-us">
      ...
      <div class="new-word">
        <div>{{ lang.holiday }}</div>
        <div v-show="this.$store.state.platform !== 21">{{ lang.niubi }}</div>
      </div>
      <div class="info">
        ...
        <div class="info-row">
          ...
          <span class="row-text">
            ...
            <a v-else href="tel:0755-25160872-8005">0755-25160872-8005</a>
          </span>
        ...
        <div class="info-row">
          ...
          <span class="row-text">
            ...
            <a v-else href="mailto:service@msjew.com">service@msjew.com</a>
          </span>
          <span class="column-line"></span>
          <span class="row-icon">
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      if (!info.telphone) {
        this.$toast(this.lang.inputTelphone)
        return
      }
