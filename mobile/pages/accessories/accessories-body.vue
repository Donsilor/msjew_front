  ...
  <div class="accessories-component">
    <div class="swiper-box">
      ...
      <div class="activity-sign" v-if="goodInfo.coupon.discount || goodInfo.coupon.money">
        <div class="triangle" v-if="goodInfo.coupon.discount">{{ this.$store.state.language == 'en_US' ? discountUs(goodInfo.coupon.discount.discount)+'%' : discountConversion(goodInfo.coupon.discount.discount)}}{{ lang.discounts2 }}</div>
        <div class="triangle" v-if="goodInfo.coupon.money">{{ lang.discounts1 }}</div>
      </div>
    </div>
    <div class="title">
      <span class="discount-icon" v-if="goodInfo.coupon.discount">{{ this.$store.state.language == 'en_US' ? discountUs(goodInfo.coupon.discount.discount)+'%' : discountConversion(goodInfo.coupon.discount.discount)}}{{ lang.discounts2 }}</span>
      ...
      <div class="discount-l">
        <div class="discoupon-d" v-if="goodInfo.coupon.discount">
          <div class="discoupon-d-l">
            ...
            <span class="discount-icon">{{ this.$store.state.language == 'en_US' ? discountUs(goodInfo.coupon.discount.discount)+'%' : discountConversion(goodInfo.coupon.discount.discount)}}{{ lang.discounts2 }}</span>
          </div>
        </div>
