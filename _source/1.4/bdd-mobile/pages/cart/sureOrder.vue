      ...
      <div class="content">
          ...
          <div class="operate">
            ...
            <div
              :class="[
                'exchange',
                {
                  disabled: !inputCouponCode && !selectCouponId
                }
              ]"
            >
              <button
        ...
        <ul class="price">
          ...
          <li v-show="preferFee > 0">
            ...
            <span class="using-coupon"
              >-{{ coin }} {{ formatMoney(preferFee) }}</span
            >
          </li>
          <li>
            <div>
...
export default {
  ...
  computed: {
    ...
    hadAddress() {
      return (
        this.address.id || (this.address.countryId && this.address.provinceId)
      )
    },
    usingCouponInfo() {
      let result = {
