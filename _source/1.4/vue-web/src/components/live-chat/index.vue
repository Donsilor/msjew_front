<template>
  <div class="live-chat">
    ...
    >
      <i class="iconfont iconicon-xiaoxi"/>
    </div>
    ...
    <div :class="['live-chat-content', { active: active }]">
      ...
      <div class="live-chat-iframe">
        ...
        <iframe
          src="https://lc.chat/now/10943482/"
          @load="finishLoad"/>
...
export default {
  ...
  methods: {
    ...
    onMousedown(e) {
      ...
      const startY = Math.floor(e.clientY);
      ...
      const deleteListener = () => {
        ...
        document.removeEventListener('mouseup', deleteListener);
        if (!hadMove) {
          _this.open();
        }
      };
      ...
      const mouseMove = event => {
        ...
        requestAnimationFrame(() => {
          const endX = Math.floor(event.clientX);
          const endY = Math.floor(event.clientY);
      ...
      document.addEventListener('mouseup', deleteListener);
    }
  }
};
</script>
