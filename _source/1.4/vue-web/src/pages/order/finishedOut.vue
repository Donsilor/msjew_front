    ...
    <div class="success-info">
      <div class="left-side">
        ...
        <div class="order-email">
          <span>{{ lang['we-will-send-to'] }}</span><span>{{ data.afterMail }}</span><i class="iconfont iconzuoshangjiantou"/>
        </div>
        <div class="order-send">{{ lang.daysGone }}</div>
        <div class="order-num">{{ lang.orderCode }}<span>{{ data.orderNo }}</span></div>
        <!--        <div class="order-guide">電匯指引</div>-->
      </div>
      <!--      -->
      <div class="right-side">
        <div class="new-address-title">
          <div class="na-line" />
          <div class="na-title">{{ lang.registered }}</div>
        </div>
        <div class="login-word">
          {{ lang.balabalabalaAgain }}
        </div>
        <div
          class="login-btn"
          @click="toLogin">{{ lang.registered }}</div>
      </div>
      <!--      -->
    </div>
