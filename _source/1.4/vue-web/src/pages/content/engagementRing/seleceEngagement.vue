...
<template>
	<div class="selece-engagement">
		<Header :title="lang.title" v-if="goods.goodsMod==1" typeId="2" icon="&#xe621;" @refresh="infoCustom()"></Header>
		<div class="d-header clearfix">
			...
			<div class="r-title">
				...
				<div class="btn"  v-if="goods.goodsStatus==2">
					...
					<a v-if="!step1 && goods.goodsMod ==1" class="add-card add-card-more" :class="!isAdd?'no-card':''" @click="addCardList">{{ lang.addCard }}</a>
					<a v-if="!step1 && goods.goodsMod !=1" class="add-card " :class="!isAdd?'no-card':''" @click="addCardList">{{ lang.addCard }}</a>
				</div>
				<div class="btn" v-if="goods.goodsStatus!=2">
...
<script>
	...
	export default {
		...
		data() {
			return {
				lang: this.$LANGUAGE.engagementRing.seleceEngagement,
				showSizeBox: 0,
				anchorPoint: 0, //锚点索引
				imgIndex: 0, //图片索引
				pullIcon: true,
